  ...
  const faqs = [
    {
      ...
      a: "Most procedures are nearly painless with modern anesthesia.",
    },
    {
      q: "How often should I visit?",
      a: "Every 6 months is recommended for checkups.",
    },
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((item, i) => (
                <AccordionItem
                  key={i}
                  value={`item-${i}`}
                  className="border-b border-black/10 last:border-0 px-2"
                >
